...
import { USER_LOGIN, SAVE_USER_LOGIN, LOGIN_LOADER, FORGOT_PASSWORD, USER_SIGNUP, SIGNUP_LOADER, SAVE_USER_SIGNUP, SAVE_FORGOT_PASSWORD, SAVE_FORGOT_PASSWORD_ERROR, SAVE_USER_LOGIN_ERROR, SAVE_USER_SIGNUP_ERROR, SAVE_RESET_PASSWORD, SAVE_RESET_PASSWORD_ERROR, RESET_PASSWORD } from "../types/login.type";
...
function* pwdReset(action) {
  ...
  try {
    const res = yield call(() =>
      axiosRequest(url, type, {...data, token: getLocalStorage("token")})
    );
    if (res) {
